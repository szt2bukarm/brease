...
export default function ImplementationsMobile({sections, openedSectionTitle, handleSelection}: any) {
    ...
    return (
        <div className="flex flex-col w-full px-[24px] pb-[80px] lg:pb-[120px] bg-background">
            ...
            <div ref={cardRef} className="relative w-full h-[357px] bg-primary p-[40px] overflow-hidden mb-[32px]">
                ...
                <img src="/ImplementationsCards/1.png" className="z-2 w-[85%] max-w-[570px] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-90%] shadow-[0_56px_112px_rgba(62,52,69,0.18)]"/>
                <img src="/ImplementationsCards/2.png" className="z-1 w-[80%] max-w-[530px] absolute top-[50%] left-[50%] translate-x-[-50%] -translate-y-[56%] [clip-path:polygon(0_50%,100%_50%,100%_100%,0%_100%)]" />
            </div>
