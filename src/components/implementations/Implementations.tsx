...
export default function Implementations() {
    ...
    useGSAP(() => {
        // gsap.set(logoRef.current, {y: 800})
    ...
    return (
        <div className="flex w-full md:px-[90px] lg:px-[11vw] pb-[80px] lg:pb-[120px] bg-background">

            {/* left col */}
            <div className="flex flex-col gap-[80px] w-[55%]">
                <div className="w-[70%]">
                    ...
                    <Heading>Powerful features that set us apart</Heading>
                </div>

                <div ref={cardRef} className="relative w-full h-full bg-primary p-[40px] overflow-hidden">
                    ...
                    <img src="/ImplementationsCards/1.png" className="z-2 w-[85%] max-w-[500px] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-90%] shadow-[0_56px_112px_rgba(62,52,69,0.18)]"/>
                    <img src="/ImplementationsCards/2.png" className="z-1 w-[80%] max-w-[470px] absolute top-[50%] left-[50%] translate-x-[-50%] -translate-y-[56%] [clip-path:polygon(0_50%,100%_50%,100%_100%,0%_100%)]" />
                </div>
            </div>

            {/* right col */}
            <div className="flex flex-col md:gap-[40px] lg:gap-[80px] w-[45%]">
                <div className="md:pl-[48px] lg:pl-[80px] pb-[40px] border-l-6 border-purple">
                    <p className="font-rale-grotesk-base-regular text-heading text-h5-mobile leading-h5-desktop md:text-h5-tablet lg:text-h5-desktop "><b>AI Assistant That Does, Not Just Suggests</b> Forget simple content prompts — Brease’s AI takes action.Create entire pages, update sections, or restructure layouts just by asking. It understands your design rules and executes updates without you digging through content trees or nested settings.</p>
                </div>

                <div className="flex flex-col md:gap-[24px] lg:gap-[32px] md:pl-[48px] lg:pl-[80px]">
