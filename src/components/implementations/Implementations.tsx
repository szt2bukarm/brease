        ...
        <div className="flex w-full md:px-[90px] lg:px-[11vw] pb-[80px] lg:pb-[120px] bg-background">
            ...
            <div className="flex flex-col gap-[80px] w-[55%]">
                <div className="w-[70%]">
                    ...
                    <p className="text-h2-mobile leading-h2-mobile md:text-h2-tablet md:leading-h2-tablet lg:text-h2-desktop lg:leading-h2-desktop text-heading tracking-[-1px]">Powerful features that set us apart</p>
                </div>

                <div className="relative w-full h-full bg-primary p-[40px] overflow-hidden">
            ...
            <div className="flex flex-col md:gap-[40px] lg:gap-[80px] w-[45%]">
                <div className="md:pl-[48px] lg:pl-[80px] pb-[40px] border-l-6 border-purple">
                    <p className="text-heading text-h5-mobile leading-h5-desktop md:text-h5-tablet  lg:text-h5-desktop "><b>AI Assistant That Does, Not Just Suggests</b> Forget simple content prompts — Brease’s AI takes action.Create entire pages, update sections, or restructure layouts just by asking. It understands your design rules and executes updates without you digging through content trees or nested settings.</p>
                </div>
