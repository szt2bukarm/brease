...
export default function Implementations({sections,openedSectionTitle, handleSelection}: any) {
    ...
    return (
        <div className="flex w-full h-full md:px-[90px] lg:px-[11vw] pb-[80px] lg:pb-[120px] bg-background">
            ...
            <div className="flex flex-col gap-[80px] w-[55%]">
                ...
                <div ref={cardRef} className="relative w-full h-[660px] bg-primary overflow-hidden flex items-center justify-center">
            ...
            {/* right col */}
            <div className="flex flex-col md:gap-[16px] lg:gap-[48px] w-[45%] ">
