    ...
    return (
        <div className="w-full bg-white flex flex-col">
            <div className={`relative w-full min-h-[47vw] md:min-h-[20vw] lg:min-h-[23vw] overflow-hidden ${bgColor === "purple" ? "bg-purple" : "bg-primary"}`}>
                ...
                <svg className={`absolute w-[790px] h-[1100px] ${logoPos === "left" ? "left-0 top-0 -translate-y-[470px] -translate-x-[100px] -rotate-[25deg] fill-purple" : "left-0 top-0 -translate-y-[470px] -translate-x-[100px] -rotate-[154deg] fill-primary"}`} viewBox="0 0 23 30">
            ...
            <div className="flex flex-col h-full justify-around w-full p-[24px] md:p-[32px] lg:p-[40px] items-start">
                <div>
                    <p className="font-abc-diatype-medium text-sm-desktop mb-[8px] text-sublabel">{label}</p>
                    <p className="text-h4-mobile leading-h4-mobile md:text-h4-tablet md:leading-h4-tablet lg:text-h4-desktop lg:leading-h4-desktop mb-[8px] text-heading">{heading}</p>
