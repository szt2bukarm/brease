    ...
    return (
        <div ref={cardRef} className="relative w-full h-full px-[24px] md:px-[90px] lg:px-[11vw] pb-[80px] lg:pb-[120px] bg-background">
            ...
            <div className="relative z-1 p-[24px] md:p-[40px] bg-white md:min-h-[512px] shadow-[0_56px_112px_-20px_rgba(62,52,69,0.18)] overflow-hidden">
                ...
                {/* bg logo */}
                <svg ref={logoRef} className={`absolute w-[790px] h-[1100px] md:w-[990px] md:h-[1300px] fill-purple rotate-[25deg] scale-x-[-1] max-md:-left-[270px] -bottom-[550px] md:right-0 md:-top-[70%] translate-x-15`} viewBox="0 0 23 30">
